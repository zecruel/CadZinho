bmp_color dxf_colors[] = {
	...
	[11] = { .r = 255, .g = 127, .b = 127, .a = 255 },
	[12] = { .r = 204, .g = 0, .b = 0, .a = 255 },
	[13] = { .r = 204, .g = 102, .b = 102, .a = 255 },
	[14] = { .r = 153, .g = 0, .b = 0, .a = 255 },
	[15] = { .r = 153, .g = 76, .b = 76, .a = 255 },
	[16] = { .r = 127, .g = 0, .b = 0, .a = 255 },
	[17] = { .r = 127, .g = 63, .b = 63, .a = 255 },
	[18] = { .r = 76, .g = 0, .b = 0, .a = 255 },
	[19] = { .r = 76, .g = 38, .b = 38, .a = 255 },
	[20] = { .r = 255, .g = 63, .b = 0, .a = 255 },
	[21] = { .r = 255, .g = 159, .b = 127, .a = 255 },
	[22] = { .r = 204, .g = 51, .b = 0, .a = 255 },
	[23] = { .r = 204, .g = 127, .b = 102, .a = 255 },
	[24] = { .r = 153, .g = 38, .b = 0, .a = 255 },
	[25] = { .r = 153, .g = 95, .b = 76, .a = 255 },
	[26] = { .r = 127, .g = 31, .b = 0, .a = 255 },
	[27] = { .r = 127, .g = 79, .b = 63, .a = 255 },
	[28] = { .r = 76, .g = 19, .b = 0, .a = 255 },
	[29] = { .r = 76, .g = 47, .b = 38, .a = 255 },
	[30] = { .r = 255, .g = 127, .b = 0, .a = 255 },
	[31] = { .r = 255, .g = 191, .b = 127, .a = 255 },
	[32] = { .r = 204, .g = 102, .b = 0, .a = 255 },
	[33] = { .r = 204, .g = 153, .b = 102, .a = 255 },
	[34] = { .r = 153, .g = 76, .b = 0, .a = 255 },
	[35] = { .r = 153, .g = 114, .b = 76, .a = 255 },
	[36] = { .r = 127, .g = 63, .b = 0, .a = 255 },
	[37] = { .r = 127, .g = 95, .b = 63, .a = 255 },
	[38] = { .r = 76, .g = 38, .b = 0, .a = 255 },
	[39] = { .r = 76, .g = 57, .b = 38, .a = 255 },
	[40] = { .r = 255, .g = 191, .b = 0, .a = 255 },
	[41] = { .r = 255, .g = 223, .b = 127, .a = 255 },
	[42] = { .r = 204, .g = 153, .b = 0, .a = 255 },
	[43] = { .r = 204, .g = 178, .b = 102, .a = 255 },
	[44] = { .r = 153, .g = 114, .b = 0, .a = 255 },
	[45] = { .r = 153, .g = 133, .b = 76, .a = 255 },
	[46] = { .r = 127, .g = 95, .b = 0, .a = 255 },
	[47] = { .r = 127, .g = 111, .b = 63, .a = 255 },
	[48] = { .r = 76, .g = 57, .b = 0, .a = 255 },
	[49] = { .r = 76, .g = 66, .b = 38, .a = 255 },
	[50] = { .r = 255, .g = 255, .b = 0, .a = 255 },
	[51] = { .r = 255, .g = 255, .b = 127, .a = 255 },
	[52] = { .r = 204, .g = 204, .b = 0, .a = 255 },
	[53] = { .r = 204, .g = 204, .b = 102, .a = 255 },
	[54] = { .r = 152, .g = 152, .b = 0, .a = 255 },
	[55] = { .r = 152, .g = 152, .b = 76, .a = 255 },
	[56] = { .r = 127, .g = 127, .b = 0, .a = 255 },
	[57] = { .r = 127, .g = 127, .b = 63, .a = 255 },
	[58] = { .r = 76, .g = 76, .b = 0, .a = 255 },
	[59] = { .r = 76, .g = 76, .b = 38, .a = 255 },
	[60] = { .r = 191, .g = 255, .b = 0, .a = 255 },
	[61] = { .r = 223, .g = 255, .b = 127, .a = 255 },
	[62] = { .r = 153, .g = 204, .b = 0, .a = 255 },
	[63] = { .r = 178, .g = 204, .b = 102, .a = 255 },
	[64] = { .r = 114, .g = 152, .b = 0, .a = 255 },
	[65] = { .r = 133, .g = 152, .b = 76, .a = 255 },
	[66] = { .r = 95, .g = 127, .b = 0, .a = 255 },
	[67] = { .r = 111, .g = 127, .b = 63, .a = 255 },
	[68] = { .r = 57, .g = 76, .b = 0, .a = 255 },
	[69] = { .r = 66, .g = 76, .b = 38, .a = 255 },
	[70] = { .r = 127, .g = 255, .b = 0, .a = 255 },
	[71] = { .r = 191, .g = 255, .b = 127, .a = 255 },
	[72] = { .r = 102, .g = 204, .b = 0, .a = 255 },
	[73] = { .r = 153, .g = 204, .b = 102, .a = 255 },
	[74] = { .r = 76, .g = 152, .b = 0, .a = 255 },
	[75] = { .r = 114, .g = 152, .b = 76, .a = 255 },
	[76] = { .r = 63, .g = 127, .b = 0, .a = 255 },
	[77] = { .r = 95, .g = 127, .b = 63, .a = 255 },
	[78] = { .r = 38, .g = 76, .b = 0, .a = 255 },
	[79] = { .r = 57, .g = 76, .b = 38, .a = 255 },
	[80] = { .r = 63, .g = 255, .b = 0, .a = 255 },
	[81] = { .r = 159, .g = 255, .b = 127, .a = 255 },
	[82] = { .r = 51, .g = 204, .b = 0, .a = 255 },
	[83] = { .r = 127, .g = 204, .b = 102, .a = 255 },
	[84] = { .r = 38, .g = 152, .b = 0, .a = 255 },
	[85] = { .r = 95, .g = 152, .b = 76, .a = 255 },
	[86] = { .r = 31, .g = 127, .b = 0, .a = 255 },
	[87] = { .r = 79, .g = 127, .b = 63, .a = 255 },
	[88] = { .r = 19, .g = 76, .b = 0, .a = 255 },
	[89] = { .r = 47, .g = 76, .b = 38, .a = 255 },
	[90] = { .r = 0, .g = 255, .b = 0, .a = 255 },
	[91] = { .r = 127, .g = 255, .b = 127, .a = 255 },
	[92] = { .r = 0, .g = 204, .b = 0, .a = 255 },
	[93] = { .r = 102, .g = 204, .b = 102, .a = 255 },
	[94] = { .r = 0, .g = 152, .b = 0, .a = 255 },
	[95] = { .r = 76, .g = 152, .b = 76, .a = 255 },
	[96] = { .r = 0, .g = 127, .b = 0, .a = 255 },
	[97] = { .r = 63, .g = 127, .b = 63, .a = 255 },
	[98] = { .r = 0, .g = 76, .b = 0, .a = 255 },
	[99] = { .r = 38, .g = 76, .b = 38, .a = 255 },
	[100] = { .r = 0, .g = 255, .b = 63, .a = 255 },
	[101] = { .r = 127, .g = 255, .b = 159, .a = 255 },
	[102] = { .r = 0, .g = 204, .b = 51, .a = 255 },
	[103] = { .r = 102, .g = 204, .b = 127, .a = 255 },
	[104] = { .r = 0, .g = 152, .b = 38, .a = 255 },
	[105] = { .r = 76, .g = 152, .b = 95, .a = 255 },
	[106] = { .r = 0, .g = 127, .b = 31, .a = 255 },
	[107] = { .r = 63, .g = 127, .b = 79, .a = 255 },
	[108] = { .r = 0, .g = 76, .b = 19, .a = 255 },
	[109] = { .r = 38, .g = 76, .b = 47, .a = 255 },
	[110] = { .r = 0, .g = 255, .b = 127, .a = 255 },
	[111] = { .r = 127, .g = 255, .b = 191, .a = 255 },
	[112] = { .r = 0, .g = 204, .b = 102, .a = 255 },
	[113] = { .r = 102, .g = 204, .b = 153, .a = 255 },
	[114] = { .r = 0, .g = 152, .b = 76, .a = 255 },
	[115] = { .r = 76, .g = 152, .b = 114, .a = 255 },
	[116] = { .r = 0, .g = 127, .b = 63, .a = 255 },
	[117] = { .r = 63, .g = 127, .b = 95, .a = 255 },
	[118] = { .r = 0, .g = 76, .b = 38, .a = 255 },
	[119] = { .r = 38, .g = 76, .b = 57, .a = 255 },
	[120] = { .r = 0, .g = 255, .b = 191, .a = 255 },
	[121] = { .r = 127, .g = 255, .b = 223, .a = 255 },
	[122] = { .r = 0, .g = 204, .b = 153, .a = 255 },
	[123] = { .r = 102, .g = 204, .b = 178, .a = 255 },
	[124] = { .r = 0, .g = 152, .b = 114, .a = 255 },
	[125] = { .r = 76, .g = 152, .b = 133, .a = 255 },
	[126] = { .r = 0, .g = 127, .b = 95, .a = 255 },
	[127] = { .r = 63, .g = 127, .b = 111, .a = 255 },
	[128] = { .r = 0, .g = 76, .b = 57, .a = 255 },
	[129] = { .r = 38, .g = 76, .b = 66, .a = 255 },
	[130] = { .r = 0, .g = 255, .b = 255, .a = 255 },
	[131] = { .r = 127, .g = 255, .b = 255, .a = 255 },
	[132] = { .r = 0, .g = 204, .b = 204, .a = 255 },
	[133] = { .r = 102, .g = 204, .b = 204, .a = 255 },
	[134] = { .r = 0, .g = 152, .b = 152, .a = 255 },
	[135] = { .r = 76, .g = 152, .b = 152, .a = 255 },
	[136] = { .r = 0, .g = 127, .b = 127, .a = 255 },
	[137] = { .r = 63, .g = 127, .b = 127, .a = 255 },
	[138] = { .r = 0, .g = 76, .b = 76, .a = 255 },
	[139] = { .r = 38, .g = 76, .b = 76, .a = 255 },
	[140] = { .r = 0, .g = 191, .b = 255, .a = 255 },
	[141] = { .r = 127, .g = 223, .b = 255, .a = 255 },
	[142] = { .r = 0, .g = 153, .b = 204, .a = 255 },
	[143] = { .r = 102, .g = 178, .b = 204, .a = 255 },
	[144] = { .r = 0, .g = 114, .b = 152, .a = 255 },
	[145] = { .r = 76, .g = 133, .b = 152, .a = 255 },
	[146] = { .r = 0, .g = 95, .b = 127, .a = 255 },
	[147] = { .r = 63, .g = 111, .b = 127, .a = 255 },
	[148] = { .r = 0, .g = 57, .b = 76, .a = 255 },
	[149] = { .r = 38, .g = 66, .b = 76, .a = 255 },
	[150] = { .r = 0, .g = 127, .b = 255, .a = 255 },
	[151] = { .r = 127, .g = 191, .b = 255, .a = 255 },
	[152] = { .r = 0, .g = 102, .b = 204, .a = 255 },
	[153] = { .r = 102, .g = 153, .b = 204, .a = 255 },
	[154] = { .r = 0, .g = 76, .b = 152, .a = 255 },
	[155] = { .r = 76, .g = 114, .b = 152, .a = 255 },
	[156] = { .r = 0, .g = 63, .b = 127, .a = 255 },
	[157] = { .r = 63, .g = 95, .b = 127, .a = 255 },
	[158] = { .r = 0, .g = 38, .b = 76, .a = 255 },
	[159] = { .r = 38, .g = 57, .b = 76, .a = 255 },
	[160] = { .r = 0, .g = 63, .b = 255, .a = 255 },
	[161] = { .r = 127, .g = 159, .b = 255, .a = 255 },
	[162] = { .r = 0, .g = 51, .b = 204, .a = 255 },
	[163] = { .r = 102, .g = 127, .b = 204, .a = 255 },
	[164] = { .r = 0, .g = 38, .b = 152, .a = 255 },
	[165] = { .r = 76, .g = 95, .b = 152, .a = 255 },
	[166] = { .r = 0, .g = 31, .b = 127, .a = 255 },
	[167] = { .r = 63, .g = 79, .b = 127, .a = 255 },
	[168] = { .r = 0, .g = 19, .b = 76, .a = 255 },
	[169] = { .r = 38, .g = 47, .b = 76, .a = 255 },
	[170] = { .r = 0, .g = 0, .b = 255, .a = 255 },
	[171] = { .r = 127, .g = 127, .b = 255, .a = 255 },
	[172] = { .r = 0, .g = 0, .b = 204, .a = 255 },
	[173] = { .r = 102, .g = 102, .b = 204, .a = 255 },
	[174] = { .r = 0, .g = 0, .b = 152, .a = 255 },
	[175] = { .r = 76, .g = 76, .b = 152, .a = 255 },
	[176] = { .r = 0, .g = 0, .b = 127, .a = 255 },
	[177] = { .r = 63, .g = 63, .b = 127, .a = 255 },
	[178] = { .r = 0, .g = 0, .b = 76, .a = 255 },
	[179] = { .r = 38, .g = 38, .b = 76, .a = 255 },
	[180] = { .r = 63, .g = 0, .b = 255, .a = 255 },
	[181] = { .r = 159, .g = 127, .b = 255, .a = 255 },
	[182] = { .r = 51, .g = 0, .b = 204, .a = 255 },
	[183] = { .r = 127, .g = 102, .b = 204, .a = 255 },
	[184] = { .r = 38, .g = 0, .b = 152, .a = 255 },
	[185] = { .r = 95, .g = 76, .b = 152, .a = 255 },
	[186] = { .r = 31, .g = 0, .b = 127, .a = 255 },
	[187] = { .r = 79, .g = 63, .b = 127, .a = 255 },
	[188] = { .r = 19, .g = 0, .b = 76, .a = 255 },
	[189] = { .r = 47, .g = 38, .b = 76, .a = 255 },
	[190] = { .r = 127, .g = 0, .b = 255, .a = 255 },
	[191] = { .r = 191, .g = 127, .b = 255, .a = 255 },
	[192] = { .r = 102, .g = 0, .b = 204, .a = 255 },
	[193] = { .r = 153, .g = 102, .b = 204, .a = 255 },
	[194] = { .r = 76, .g = 0, .b = 152, .a = 255 },
	[195] = { .r = 114, .g = 76, .b = 152, .a = 255 },
	[196] = { .r = 63, .g = 0, .b = 127, .a = 255 },
	[197] = { .r = 95, .g = 63, .b = 127, .a = 255 },
	[198] = { .r = 38, .g = 0, .b = 76, .a = 255 },
	[199] = { .r = 57, .g = 38, .b = 76, .a = 255 },
	[200] = { .r = 191, .g = 0, .b = 255, .a = 255 },
	[201] = { .r = 223, .g = 127, .b = 255, .a = 255 },
	[202] = { .r = 153, .g = 0, .b = 204, .a = 255 },
	[203] = { .r = 178, .g = 102, .b = 204, .a = 255 },
	[204] = { .r = 114, .g = 0, .b = 152, .a = 255 },
	[205] = { .r = 133, .g = 76, .b = 152, .a = 255 },
	[206] = { .r = 95, .g = 0, .b = 127, .a = 255 },
	[207] = { .r = 111, .g = 63, .b = 127, .a = 255 },
	[208] = { .r = 57, .g = 0, .b = 76, .a = 255 },
	[209] = { .r = 66, .g = 38, .b = 76, .a = 255 },
	[210] = { .r = 255, .g = 0, .b = 255, .a = 255 },
	[211] = { .r = 255, .g = 127, .b = 255, .a = 255 },
	[212] = { .r = 204, .g = 0, .b = 204, .a = 255 },
	[213] = { .r = 204, .g = 102, .b = 204, .a = 255 },
	[214] = { .r = 152, .g = 0, .b = 152, .a = 255 },
	[215] = { .r = 152, .g = 76, .b = 152, .a = 255 },
	[216] = { .r = 127, .g = 0, .b = 127, .a = 255 },
	[217] = { .r = 127, .g = 63, .b = 127, .a = 255 },
	[218] = { .r = 76, .g = 0, .b = 76, .a = 255 },
	[219] = { .r = 76, .g = 38, .b = 76, .a = 255 },
	[220] = { .r = 255, .g = 0, .b = 191, .a = 255 },
	[221] = { .r = 255, .g = 127, .b = 223, .a = 255 },
	[222] = { .r = 204, .g = 0, .b = 153, .a = 255 },
	[223] = { .r = 204, .g = 102, .b = 178, .a = 255 },
	[224] = { .r = 152, .g = 0, .b = 114, .a = 255 },
	[225] = { .r = 152, .g = 76, .b = 133, .a = 255 },
	[226] = { .r = 127, .g = 0, .b = 95, .a = 255 },
	[227] = { .r = 127, .g = 63, .b = 111, .a = 255 },
	[228] = { .r = 76, .g = 0, .b = 57, .a = 255 },
	[229] = { .r = 76, .g = 38, .b = 66, .a = 255 },
	[230] = { .r = 255, .g = 0, .b = 127, .a = 255 },
	[231] = { .r = 255, .g = 127, .b = 191, .a = 255 },
	[232] = { .r = 204, .g = 0, .b = 102, .a = 255 },
	[233] = { .r = 204, .g = 102, .b = 153, .a = 255 },
	[234] = { .r = 152, .g = 0, .b = 76, .a = 255 },
	[235] = { .r = 152, .g = 76, .b = 114, .a = 255 },
	[236] = { .r = 127, .g = 0, .b = 63, .a = 255 },
	[237] = { .r = 127, .g = 63, .b = 95, .a = 255 },
	[238] = { .r = 76, .g = 0, .b = 38, .a = 255 },
	[239] = { .r = 76, .g = 38, .b = 57, .a = 255 },
	[240] = { .r = 255, .g = 0, .b = 63, .a = 255 },
	[241] = { .r = 255, .g = 127, .b = 159, .a = 255 },
	[242] = { .r = 204, .g = 0, .b = 51, .a = 255 },
	[243] = { .r = 204, .g = 102, .b = 127, .a = 255 },
	[244] = { .r = 152, .g = 0, .b = 38, .a = 255 },
	[245] = { .r = 152, .g = 76, .b = 95, .a = 255 },
	[246] = { .r = 127, .g = 0, .b = 31, .a = 255 },
	[247] = { .r = 127, .g = 63, .b = 79, .a = 255 },
	[248] = { .r = 76, .g = 0, .b = 19, .a = 255 },
	[249] = { .r = 76, .g = 38, .b = 47, .a = 255 },
